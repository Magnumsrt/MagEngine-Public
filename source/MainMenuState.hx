...
class MainMenuState extends MusicBeatState
{
	...
	#if !switch
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if MODS 'mods', #end 'donate', 'options'];
	#else
	...
	override function create()
	{
		...
		{
			var menuItem:FlxSprite = new FlxSprite(0, i * 160);
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "FNF v0.2.7.1 - Mag Engine v" + Application.current.meta.get('version'), 12);
